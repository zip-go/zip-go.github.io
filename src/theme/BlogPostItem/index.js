...
function BlogPostItem(props) {
  ...
  useEffect(() => {
    ...
    const createGiscusEl = () => {
      ...
      script.setAttribute("data-repo", "zip-go/zip-go.github.io");
      script.setAttribute("data-repo-id", "R_kgDOJ67O1Q");
      script.setAttribute("data-category", "Announcements");
      script.setAttribute("data-category-id", "DIC_kwDOJ67O1c4CX2n1");
